...
class ExactModelValidator:
    ...
    def __init__(self, model_path, data_path):
        ...
        # 创建结果目录
        self.results_dir = "exact_validation_results"
        ...
        logger.info(f"🚀 初始化精确模型验证器，使用设备: {self.device}")
    ...
    def text_to_sequence(self, text, max_length=128):
        ...
        if self.vocab:
            ...
            sequence = [hash(word) % 8000 for word in words]
    ...
    def run_validation(self, num_validations=3):
        ...
        try:
            ...
            # 5. 执行验证
            result = self.validate_model(df, features, labels, "exact_validation")
    ...
    def save_results(self, result):
        ...
        try:
            ...
            # 保存验证结果
            results_file = os.path.join(self.results_dir, f"exact_validation_results_{timestamp}.json")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="精确模型验证器")
